...
OTA and HTTP updates from GitHub. The device checks a manifest on GitHub Pages for stable and beta builds. Controls: device web UI at `http://<device-ip>/` under **Firmware** (and in Home Assistant).
