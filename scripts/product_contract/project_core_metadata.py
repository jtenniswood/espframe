...
def check_project_required_metadata(product: dict, errors: list[str]) -> None:
    ...
    for field in (
        ...
        "home_assistant_api_encryption_mode",
        "home_assistant_api_encryption_minimum_version",
        "home_assistant_api_encryption_recommended_version",
        "home_assistant_api_encryption_key_policy",
        "home_assistant_api_encryption_key_exclusions",
        "home_assistant_api_encryption_persistence",
        "home_assistant_api_encryption_factory_reset_behavior",
